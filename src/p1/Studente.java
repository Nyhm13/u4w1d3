...
//    // queste sono le variabili di istanza/attributi ovvero le caratteristiche del nostro oggetto studente
//
//    public String nome;
...
//
//
//    // questo è il costruttore parametrizzato  della classe studente
//    public p1.Studente(int matricola, int eta, String nome, String cognome) {
//        this.nome = nome;
...
//
//
//    // questo metodo e void perche non ritorna nulla stampa solo  le info dello studente
//    // questo metodo è un metodo che stampa le caratteristiche di un oggetto
//
//    public  void stampa(){
//        System.out.println("Nome: "+ nome + ",cognome:"+ cognome + ", matricola: "+ matricola + ", eta: "+ eta);
//    }
